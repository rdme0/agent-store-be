...
public enum ErrorCode {
    ...
    INVALID_ENDPOINT(Domain.AGENT, HttpStatus.BAD_REQUEST, 2, "Agent endpoint가 올바르지 않습니다."),
    ...
    UNSAFE_AGENT_ENDPOINT(Domain.AGENT, HttpStatus.BAD_REQUEST, 5, "안전하지 않은 Agent endpoint입니다."),
    ...
    DEPENDENCY_DEPTH_EXCEEDED(Domain.DEPENDENCY, HttpStatus.UNPROCESSABLE_CONTENT, 2, "Dependency graph depth가 최대값을 초과했습니다."),
    DEPENDENCY_PRICE_EXCEEDED(Domain.DEPENDENCY, HttpStatus.UNPROCESSABLE_CONTENT, 3, "Dependency 가격이 허용 상한을 초과했습니다."),
    EXECUTION_STEPS_EXCEEDED(Domain.DEPENDENCY, HttpStatus.UNPROCESSABLE_CONTENT, 4, "Dependency graph의 실행 step 수가 최대값을 초과했습니다."),
