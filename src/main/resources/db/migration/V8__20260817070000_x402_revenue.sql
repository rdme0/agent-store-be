...
ALTER TABLE "revenue_entries"
    ADD CONSTRAINT "revenue_entries_developer_id_fkey" FOREIGN KEY ("developer_id") REFERENCES "developers" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "revenue_entries"
    ADD CONSTRAINT "revenue_entries_execution_step_id_fkey" FOREIGN KEY ("execution_step_id") REFERENCES "execution_steps" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "revenue_entries"
    ADD CONSTRAINT "revenue_entries_payment_attempt_id_fkey" FOREIGN KEY ("payment_attempt_id") REFERENCES "payment_attempts" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
