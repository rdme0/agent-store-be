...
ALTER TABLE "executions" ADD CONSTRAINT "executions_quote_id_fkey" FOREIGN KEY ("quote_id") REFERENCES "execution_quotes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "execution_steps" ADD CONSTRAINT "execution_steps_parent_step_id_fkey" FOREIGN KEY ("parent_step_id") REFERENCES "execution_steps"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "execution_steps" ADD CONSTRAINT "execution_steps_agent_version_id_fkey" FOREIGN KEY ("agent_version_id") REFERENCES "agent_versions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "payment_attempts" ADD CONSTRAINT "payment_attempts_execution_step_id_fkey" FOREIGN KEY ("execution_step_id") REFERENCES "execution_steps"("id") ON DELETE CASCADE ON UPDATE CASCADE;
